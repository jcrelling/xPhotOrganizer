...
##        self.folder_format = self.config.get('main', 'folder_format')
        ...
        QtGui.QLabel("Destination folder", self).setGeometry(
            QtCore.QRect(320, 420, 140, 20))
        ...
        self.tb.addAction(QtGui.QIcon("image/source1.png"),
            'Source folder', self.ChgDirBtnClk)
        self.tb.addAction(QtGui.QIcon("image/destination1.png"),
            'Destination folder', self.ChgDstDirBtnClk)
        self.tb.addSeparator()
        self.tb.addAction(QtGui.QIcon("image/run1.png"),
            'Copy files', self.CpyFileBtnClk)
        self.tb.addSeparator()
        self.tb.addAction(QtGui.QIcon("image/config1.png"),
            'Config', self.ConfigurationW)
        self.tb.addSeparator()
        self.tb.addAction(QtGui.QIcon("image/exit1.png"),
            'Exit', self.destroy)
        self.tb.adjustSize()
    ...
    def ChgDirBtnClk(self):
        self.rootDir = QtGui.QFileDialog.getExistingDirectory(self,
            ("Choose Directory"), self.root_path,
    ...
    def ChgDstDirBtnClk(self):
        self.DstDir = QtGui.QFileDialog.getExistingDirectory(self,
            ("Choose Directory"), self.dest_path,
            QtGui.QFileDialog.ShowDirsOnly | QtGui.QFileDialog.DontResolveSymlinks)
